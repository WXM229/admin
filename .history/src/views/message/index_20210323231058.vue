...
export default {
  methods: {
    ...
    clickPhone(){
      ...
      console.log(newtableData1, '1')
      this.saveAry = JSON.parse(JSON.stringify(newtableData1))
      console.log(this.saveAry, 'ary')
      this.tableData.forEach((item)=>{
        if(this.input == item.number){
          newtableData.push(item)
          this.tableData = newtableData.slice(0) 
    ...
    closePhone(){
      this.input = ''
      this.tableData = JSON.parse(JSON.stringify(this.newtableData1))
