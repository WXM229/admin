  ...
  methods: {
    ...
    handleChang() {
      ...
      this.tableData.forEach((item)=>{
        if(this.form.id == item.id && this.form.name == item.name && this.value == item.level&& this.valueTypeAll==item.is_delay_allocate_str &&this.valueRoles ==item.allocate_role_str&&){
          console.log(11);
        }
      })
    },
