        ...
        <el-row>
          <el-col :span="6" :offset="2">
            <el-form-item label="ID">
              <el-input v-model="form.id" style="width: 195px" />
            </el-form-item>
          </el-col>
          <el-col :span="6">
        ...
        <el-row>
          <el-col :span="6" :offset="2">
            <el-form-item label="分配类型">
              <el-select
                v-model="valueTypeAll"
                placeholder="请选择"
                @change="selectChange1($event)"
              >
                <el-option
          ...
          <el-col :span="6">
            <el-form-item label="自约课是否直分cc">
              <el-select
                v-model="valueOptionsCC"
                placeholder="请选择"
                @change="selectChange3($event)"
              >
                <el-option
    ...
    <div>
      <el-card class="box-card" style="margin-top: 20px" shadow="always">
        <el-table :data="tableData" style="width: 100%" border>
          ...
          <el-table-column prop="name" label="激活方式名称" />
          <el-table-column prop="level" label="激活级别" />
          ...
          <el-table-column prop="sales_talk" label="话术" />
...
export default {
  ...
  methods: {
    ...
    handleChang() {
      ...
      // console.log(this.valueTypeAll);
      // console.log(this.valueRoles);
      // console.log(this.valueOptionsCC);
      // console.log(this.valueState);
      // const newtableData1 = JSON.parse(JSON.stringify(this.tableData))
      this.tableData.forEach((item) => {
        // if (
        //   this.form.id == item.id &&
        //   this.form.name == item.name &&
        //   this.value == item.level &&
        //   this.valueTypeAll == item.is_delay_allocate_str &&
        //   this.valueRoles == item.allocate_role_str &&
        //   this.valueOptionsCC == item.auto_allocate_str &&
        //   this.valueState == item.status_str
        // ) {
        //   console.log(item)
