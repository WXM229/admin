<template>
  <div>
    ...
    <el-table
      ...
      border
      style="width: 100%"
      v-for="(item) in this.tableDate.data"
      :key="id"
    >
      <el-table-column prop="id" label="操作人" width="100" align="center">
      </el-table-column>
      <el-table-column prop="create_time" label="发送时间" width="130" align="center">
      </el-table-column>
      <el-table-column
        prop="type"
        label="短信类型"
