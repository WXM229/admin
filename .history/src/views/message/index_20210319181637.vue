  ...
  <div>
    ...
    <el-dialog title="选择短信模版" :visible.sync="dialogVisible" width="50%">
      <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
        <el-tab-pane label="加微信" name="first" v-for="item in ageData.data" :key="item">
          <p>提醒：加微信类型短信每个用户最多可以发送6次超过次数将无法发送</p>
          <el-radio v-model="radio" label="1" class="radio1">
            <span class="fontStyle"
              >{{item.content}}小叶子】尾号{变量A-手机尾号后4位}家长:我是小叶子智能陪练的老师,现在由我负责您的孩子在小叶子的学习,提醒您添加下我的微信,便于带孩子学习哦.添加微信更有练琴干货,返双倍学费,郎朗亲笔签名奖状等你来拿.{变量B-助教微信号}点击链接添加老师微信:{变量C-添加助教微信链接}</span
            ></el-radio
          >
