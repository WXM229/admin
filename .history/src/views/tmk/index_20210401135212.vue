        ...
        <el-row>
          <el-col :span="6" :offset="2">
            <el-form-item label="分配类型">
              <el-select v-model="valueTypeAll" placeholder="请选择" @change="selectChange1($event)">
                <el-option
          ...
          <el-col :span="6">
            <el-form-item label="分配角色">
              <el-select v-model="valueRoles" placeholder="请选择" @change="selectChange2($event)">
                <el-option
                  v-for="item in roles"
                  :key="item.value"
                  :label="item.label"
          ...
          <el-col :span="6">
            <el-form-item label="自约课是否直分cc">
              <el-select v-model="valueOptionsCC" placeholder="请选择" @change="selectChange3($event)">
                <el-option
        ...
        <el-row>
          <el-col :span="6" :offset="2">
            <el-form-item label="状态">
              <el-select v-model="valueState" placeholder="请选择" @change="selectChange4($event)">
                <el-option
                  v-for="item in state"
                  :key="item.value"
                  :label="item.label"
